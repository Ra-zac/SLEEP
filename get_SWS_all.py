...
files_done.append('S20S1.csv')
files_done.append('E30S1.csv')
files_done.append('C19S1.csv')
files_done.append('S02S1.csv')
...
for i, ppsext in enumerate(all_files):
    ...
    output = '/home/amoran/YASA/SWSdata/all_N3/' + pps +'.csv'
...
#        raw = raw.set_eeg_reference(ref_channels=['EEG A1','EEG A2'])
    ...
    kwargs = {"hypno": hyp_yasa, "remove_outliers":True, "include":(3)}
