...
path = r'/home/amoran/YASA/LGi1_controls/'
...
for i, ppsext in enumerate(all_files):
    ...
    hypnogram = '/home/amoran/YASA/LGi1_controls/' + pps[:3] + '/' + pps[3:] + '/sleep/hypnogram.csv'
    arfile = '/home/amoran/YASA/LGi1_controls/' + pps[:3] + '/' + pps[3:] + '/sleep/arousal.csv'
    edffile = '/home/amoran/YASA/LGi1_controls/' + pps[:3] + '/' + pps[3:] + '/sleep/'
    syst = 'NEW'
...
#        raw = raw.set_eeg_reference(ref_channels=['EEG A1','EEG A2'])
    ...
    if syst=='OLD':
        ...
        if pps[:3]=='E01':
            raw_con = raw_con.pick(['EEG F7', 'EEG F3', 'EEG Fz', 'EEG F4', 'EEG F8', 'EEG C3', 'EEG Cz', 'EEG C4',
            'EEG P3', 'EEG Pz', 'EEG P4', 'EEG O1', 'EEG O2', 'EEG PO3', 'EEG POz', 'EEG PO4',
            'EEG A1', 'EEG A2'])
        else:
