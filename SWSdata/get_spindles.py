...
path = r'/home/albert/sleep/SPNDLdata'
os.chdir(path)
files_done = glob.glob("*.csv")
files_done.append('S07S1.csv')
files_done.append('C19S1.csv')
#files_done.append('E01S1.csv')
#files_done.append('C23S4.csv')
#files_done.append('E16S4.csv')
#files_done.append('E18S2.csv')
...
for i, ppsext in enumerate(all_files):
    ...
    edffile = '/home/kanthida/Documents/missing EDF/' + pps + '.EDF'
    syst = 'NEW'
...
#        raw = raw.set_eeg_reference(ref_channels=['EEG A1','EEG A2'])
    ...
    if syst=='OLD':
        ...
        for i, fl in enumerate(files):
            ...
            raw = mne.io.read_raw_edf(fl, preload = True)
            raw.resample(sf, npad='auto')
        ...
        if pps[:3]=='E01':
            raw_con = raw_con.pick(['EEG F7', 'EEG F3', 'EEG Fz', 'EEG F4', 'EEG F8', 'EEG T3', 'EEG C3', 'EEG Cz', 'EEG C4',
            'EEG T4', 'EEG T5', 'EEG P3', 'EEG Pz', 'EEG P4', 'EEG T6', 'EEG O1', 'EEG O2', 'EEG PO3', 'EEG POz', 'EEG PO4',
            'EEG A1', 'EEG A2'])
        else:
            raw_con = raw_con.pick(['EEG Fp1', 'EEG Fpz', 'EEG Fp2', 'EEG AF7', 'EEG AFz', 'EEG AF8', 'EEG F7', 'EEG F3', 'EEG Fz', 
                    'EEG F4', 'EEG F8', 'EEG FT7', 'EEG FC3', 'EEG FCz', 'EEG FC4', 'EEG FT8', 'EEG A1', 'EEG T7', 
                    'EEG C5', 'EEG C3', 'EEG Cz', 'EEG C4', 'EEG C6', 'EEG T8', 'EEG A2', 'EEG TP7', 'EEG CP3', 'EEG CPz', 
                    'EEG CP4', 'EEG TP8', 'EEG P7', 'EEG P3', 'EEG Pz', 'EEG P4', 'EEG P8', 'EEG PO7', 'EEG PO3', 'EEG POz', 
                    'EEG PO4', 'EEG PO8', 'EEG O1', 'EEG Oz', 'EEG O2'])
    ...
    kwargs = {"hypno": hyp_yasa, "remove_outliers":True, "multi_only":False, "include":(2,3)}
    #sw = yasa.sw_detect_multi(raw, **kwargs)
    sp = yasa.spindles_detect(raw, **kwargs) 

    print(sp.summary().shape[0], 'spindles detected.')
